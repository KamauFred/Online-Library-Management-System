...
<body>
  ...
  <header class="header">
    <div class="headflex">
      ...
      <div class="navbar">
        ...
        <a href="login.php">browse</a>
        <a href="login.php">borrow</a>
  ...
  <section class="banner">
    ...
    <div class="bannercon">
      ...
      <div class="bannertext">
        ...
        <button class="prim"><a href="login.php">Explore</a></button>
      </div>
      ...
      <div class="services-sec" id="services">
        ...
        <div class="serv-box">
          ...
          <div class="serv-text">
            ...
            <button class="prim"><a href="#">Explore</a></button>
          </div>
        ...
        <div class="serv-box res">
          ...
          <div class="serv-text">
            ...
            <button class="prim"><a href="donate.php">Donate</a></button>
          </div>
  ...
  <section class="trend">
    ...
    <div class="trendsec">
      ...
      <div class="trendbooks">

        <!--book 1-->
        <div class="bookbox">
          <div class="bookimg">
            <a href="#"><img src="tomimages/background/mist.jpg"></a>
          </div>
          <button class="prim"><a href="login.php">Read</a></button>
        </div>

        <!--book 2-->
        <div class="bookbox">
          <div class="bookimg">
            <a href="#"><img src="tomimages/background/mist2.jpg"></a>
          </div>
          <button class="prim"><a href="login.php">Read</a></button>
        </div>
        ...
        <div class="bookbox">
          <div class="bookimg">
            <a href="#"><img src="tomimages/background/mist3.jpg"></a>
          </div>
          <button class="prim"><a href="login.php">Read</a></button>
        </div>
        ...
        <div class="bookbox">
          <div class="bookimg">
            <a href="#"><img src="tomimages/background/mist4.jpg"></a>
          </div>
          <button class="prim"><a href="login.php">Read</a></button>
        </div>
        ...
        <div class="bookbox">
          <div class="bookimg">
            <a href="#"><img src="tomimages/background/mist5.jpg"></a>
          </div>
          <button class="prim"><a href="login.php">Read</a></button>
        </div>
        ...
        <div class="bookbox">
          <div class="bookimg">
            <a href="#"><img src="tomimages/background/mist6.jpg"></a>
          </div>
          <button class="prim"><a href="login.php">Read</a></button>
        </div>
  ...
  <section class="trend">
    ...
    <div class="trendsec">
      ...
      <div class="trendbooks">
        ...
        <div class="bookbox">
          <div class="bookimg">
            <a href="#"><img src="tomimages/background/new1.jpg"></a>
          </div>
          <button class="prim"><a href="login.php">Read</a></button>
        </div>
        ...
        <div class="bookbox">
          <div class="bookimg">
            <a href="#"><img src="tomimages/background/new2.jpg"></a>
          </div>
          <button class="prim"><a href="login.php">Read</a></button>
        </div>
        ...
        <div class="bookbox">
          <div class="bookimg">
            <a href="#"><img src="tomimages/background/new3.jpg"></a>
          </div>
          <button class="prim"><a href="login.php">Read</a></button>
        </div>
        ...
        <div class="bookbox">
          <div class="bookimg">
            <a href="#"><img src="tomimages/background/new4.jpg"></a>
          </div>
          <button class="prim"><a href="login.php">Read</a></button>
        </div>
        ...
        <div class="bookbox">
          <div class="bookimg">
            <a href="#"><img src="tomimages/background/new5.jpg"></a>
          </div>
          <button class="prim"><a href="login.php">Read</a></button>
        </div>
        ...
        <div class="bookbox">
          <div class="bookimg">
            <a href="#"><img src="tomimages/background/new6.jpg"></a>
          </div>
          <button class="prim"><a href="login.php">Read</a></button>
        </div>
